...
int UInventoryComponent::LoadFrom(const FInvStore &InvStore)
{
	ClearAll();
...
FInvStore UInventoryComponent::SaveTo() const
{
	FInvStore inv_store;
...
void UInventoryComponent::Arrange()
{
	// clear all
	notfull_.clear();
	free_list_.clear();
...
int UInventoryComponent::DropItemInSpecificSlot(int index)
{
